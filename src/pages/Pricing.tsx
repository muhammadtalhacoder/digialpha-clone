...
const defaultPricing: PricingItem[] = [
  { _id: "1", title: "Custom Emotes", description: "High-quality Twitch/Discord emotes. Perfect for your streaming channel.", category: "Emotes", price: 25 },
  { _id: "2", title: "Sub Badges", description: "Loyalty badges for your subscribers. Multiple tiers available.", category: "Badges", price: 40 },
  { _id: "3", title: "Channel Banner", description: "Eye-catching banner design for YouTube or Twitch.", category: "Banners", price: 60 },
  { _id: "4", title: "Stream Overlays", description: "Animated overlays for your stream. Includes alerts and scenes.", category: "Overlays", price: 100 },
  { _id: "5", title: "Thumbnail Pack", description: "Professional thumbnails for your content.", category: "Thumbnails", price: 75 },
  { _id: "6", title: "Fursuit Head Design", description: "Full custom fursuit head reference with multiple angles.", category: "Fursuit", price: 200 },
  { _id: "7", title: "VTuber Model", description: "Live2D ready character model with expressions.", category: "VTuber", price: 350 },
  { _id: "8", title: "Full Fursuit Reference", description: "Complete character reference sheet with full body views.", category: "Fursuit", price: 500 },
];
...
const Pricing = () => {
  ...
  useEffect(() => {
    const loadItems = async () => {
      ...
      setItems(data.length > 0 ? data : defaultPricing);
      setLoading(false);
    };
    loadItems();
  }, []);
